    ...
    <div class="page-layout-body">
                        ...
                        <ul class="ant-list-items">
                            <div id="data_news">
                                <li class="ant-list-item home_page_listItem__GD_iE">
                                    <img src="/Assets/Images/osFJ5m8.png" class="home_page_listItemAvatar__cXjbm" />
                                    <div class="ant-list-item-meta home_page_listItemTitle__YB3V5">
                                        <div class="ant-list-item-meta-content">
                                            <h4 class="ant-list-item-meta-title">
                                                <a href="/Post/New3">Update sự Kiện Đua
                                                    top</a>
                                            </h4>
                                            <div class="ant-list-item-meta-description">Đăng
                                                bởi: <b style="color: red;">ADMIN</b> - Ngày:
                                                19/3/2024</div>
                                        </div>
                                    </div>
                                </li>
                                <li class="ant-list-item home_page_listItem__GD_iE">
                                    ...
                                    <div class="ant-list-item-meta home_page_listItemTitle__YB3V5">
                                        <div class="ant-list-item-meta-content">
                                            <h4 class="ant-list-item-meta-title">
                                                <a href="/Post/New2">Hướng Dẫn Up Sét Kích
                                                    Hoạt</a>
                                            </h4>
                                            <div class="ant-list-item-meta-description">Đăng
                                                bởi: <b style="color: red;">ADMIN</b> - Ngày:
                                ...
                                <li class="ant-list-item home_page_listItem__GD_iE">
                                    ...
                                    <div class="ant-list-item-meta home_page_listItemTitle__YB3V5">
                                        <div class="ant-list-item-meta-content">
                                            <h4 class="ant-list-item-meta-title">
                                                <a href="/Post/New1">Hướng Dẫn Mở Thành
                                                    Viên</a>
                                            </h4>
                                            <div class="ant-list-item-meta-description">Đăng
                                                bởi: <b style="color: red;">ADMIN</b> - Ngày:
        ...
        <div class="ant-col ant-col-24">
            <div class="home_page_listItem__GD_iE" style="display:flex">
                ...
                <br />
                - Tất cả các sách kỹ năng đều có thể học miễn phí tại Quy Lão Kame, khi bạn có
                đủ điểm tiềm năng.
                <br />
                - Bạn không thể bay, dùng kỹ năng, nếu hết KI.
                <br />- Tấn công quái vật cùng bạn bè trong Bang sẽ mang lại nhiều điểm tiềm
                năng hơn đánh một mình.
                <br />- Tập luyện với bạn bè tại khu vực thích hợp sẽ mang lại nhiều điểm tiềm
                năng hơn
                đánh quái vật.
                <br />- Khi được nâng cấp, đậu thần sẽ phục hồi nhiều HP và KI hơn.
                <br />- Vào trò chơi đều đặn mỗi ngày để nhận được Ngọc miễn phí.
                <br />- Đùi gà sẽ phục hồi 100% HP, KI. Cà chua phục hồi 100% KI. Cà rốt phục
                hồi
                100% HP.
        ...
        <div class="ant-col ant-col-24 home_page_textDetail__BTiTp">
            <div style="background:#e37745;padding:10px;border-radius:10px">Trò Chơi Trực Tuyến
                với cốt truyện xoay quanh bộ truyện tranh 7 viên Ngọc
                ...
                Android, iPhone, Windows Phone, và máy tính bảng Android, iPad.</div>
        </div>
    </div> <!-- end load view -->
</div>
</div>
